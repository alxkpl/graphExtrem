...
*Finally, it is not... But there is what I've done which indicate the equality is false.* Let's see if it is the case for our previous simulations. We obtained :   

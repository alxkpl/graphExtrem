...
Now let's take the previous Husler-reiss model and let's add a random noise $\varepsilon_{ij} \sim \mathcal N(0, (0.01)^2)$ for each coefficient. That means we will build the data with the following matrix :

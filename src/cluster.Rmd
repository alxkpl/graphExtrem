...
$$
\arg\min_\Theta \{ L(\Theta) + \lambda\mathcal{P}(\Theta) \} , \quad \quad \Theta \in \mathcal P^1_d.
$$
...
```{r first-rep-sim-plot, echo = FALSE}
#| fig.cap: Summary of the optimization results with the $\lambda$.
